...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Используем только сертифицированные препараты, безвредные для детей и животных"
    },
    {
      icon: "CheckCircle",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-200 leading-relaxed">
                ...
                Безопасные методы для вашей семьи и питомцев.
              </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-medium">+7 (495) 123-45-67</span>
                </div>
                <div className="flex items-center gap-3">
